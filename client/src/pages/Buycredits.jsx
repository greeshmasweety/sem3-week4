...
const plans = [
  { id: 1, desc: 'Basic Plan', price: 10, credits: 100 },
  { id: 2, desc: 'Standard Plan', price: 20, credits: 250 },
  { id: 3, desc: 'Premium Plan', price: 30, credits: 500 },
];
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((item, index) => (
          ...
          >
            ...
            <p className='mt-3 font-semibold'>{item.desc}</p>
